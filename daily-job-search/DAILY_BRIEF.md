...
The current approved position is 3+ years of combined professional and internship experience, as confirmed on 13 September 2026; dated Infocepts experience runs February 2023 to July 2025, including the initial training role. Additional internship chronology is unspecified, plus an MSc programme in Data Science in progress at Munster Technological University (September 2025 to September 2026). Do not infer completion from the calendar. Distinguish professional, training, academic and candidate-project evidence.
...
5. For each selected JD, save a concise sourced snapshot, company-problem research and requirement-to-evidence map. Write a distinct summary, skill ordering and experience emphasis, and select exactly two distinct relevant resume-ready registered projects. Do not imply the project was built for the target company.
...
- Additional internship employers and dates supporting the confirmed combined 3+ years; the July 2025 employment end date is resolved.
