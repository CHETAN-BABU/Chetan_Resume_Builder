...
4. Prepare the draft through the dashboard or `scripts/career.py`. Select exactly one `resume_ready` project. The initial summary and other experience remain the approved base wording; tailor them to the JD without strengthening claims.
